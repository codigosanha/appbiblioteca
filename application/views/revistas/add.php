<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Registrar Revista</h3>
        ...
        <?php endif ?>
        <?php echo form_open('revistas/store', "enctype=multipart/form-data"); ?>
        <div class="box-body">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="numero_registro">Nro de Registro</label>
                    <input type="text" id="numero_registro" class="form-control" id="numero_registro" name="numero_registro" placeholder="Numero Registro" required="required" value="<?php echo set_value('numero_registro'); ?>">
                </div>
                <div class="form-group <?php echo form_error('codigo_ubicacion') == true ? 'has-error' : '' ?>">
                    ...
                    <input type="text" class="form-control" id="codigo_ubicacion" name="codigo_ubicacion" placeholder="Codigo Ubicacion" value="<?php echo set_value('codigo_ubicacion'); ?>" required="required">
                    <?php echo form_error('codigo_ubicacion'); ?>
                </div>
                <div class="form-group">
                    <label for="revista">Revista</label>
                    <input type="text" id="revista" class="form-control" id="revista" name="revista" placeholder="Revista" required="required" value="<?php echo set_value('revista'); ?>">
                </div>
                <div class="form-group">
                    <label for="titulo">Titulo</label>
                    <input type="text" id="titulo" class="form-control" id="titulo" name="titulo" placeholder="Numero Registro" required="required" value="<?php echo set_value('titulo'); ?>">
                </div>
                <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="lugar" name="lugar" placeholder="Lugar" maxlength="15" value="<?php echo set_value('lugar'); ?>">
            </div>
