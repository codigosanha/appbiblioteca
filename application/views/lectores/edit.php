<section class="content">
    ...
    <div class="box">
        ...
        <?php endif ?>
        <?php echo form_open('lectores/update', "enctype=multipart/form-data"); ?>
        ...
        <div class="box-body">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Nombres" required="required" value="<?php echo $lector->nombres;?>">
                </div>
                <div class="form-group">
                    <label for="apellidos">Apellidos:</label>
                    <input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Apellidos" required="required" value="<?php echo $lector->apellidos;?>">
                </div>
                <div class="form-group">
                    ...
                    <select name="tipo_documento_id" id="tipo_documento_id" class="form-control" required="required">
                        ...
                        <?php foreach ($tipodocumentos as $tipodocumento): ?>
                            <option value="<?php echo $tipodocumento->id; ?>" <?php echo $tipodocumento->id == $lector->tipo_documento_id ? 'selected':'';?>><?php echo $tipodocumento->nombre; ?></option>
                        <?php endforeach;?>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="tipo_lector_id" id="tipo_lector_id" class="form-control" required="required">
                        ...
                        <?php foreach ($tipolectores as $tipolector): ?>
                            <option value="<?php echo $tipolector->id; ?>" <?php echo $tipolector->id == $lector->tipo_lector_id ? 'selected':'';?>><?php echo $tipolector->nombre; ?></option>
                        <?php endforeach;?>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="direccin" name="direccion" placeholder="Direccion" value="<?php echo $lector->direccion;?>">
                </div>
                <div class="form-group">
